...
| `calendarTopAreaJSX`             | `IRenderJSX`                          | `undefined`                                        | This allow you to add JSX above the calendar area                                                                              |
...
| `month`                          | `Accessor<number>`                    | `undefined`                                        | This allows you pass in a state that accessor value replacing the default one                                                  |
...
| `showCloseOnSelect`              | `boolean`                             | `false`                                            | Should datepicker pop up close when date is selected                                                                           |
