...
export function clickOutsideSJ(el, accessor) {
    const onClick = (e) => !el.contains(e.target) && accessor(e)?.(e);
    document.body.addEventListener("click", onClick);
    onCleanup(() => document.body.removeEventListener("click", onClick));
}
export const upgradedSmartDropDown = ({ inputRef, dropDownRef, positionX, positionY, }) => {
