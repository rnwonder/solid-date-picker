...
-
### Themes
- When adding themes we generally want the file to in css format. That way anyone can use it without having to install any package like sass and the likes.
